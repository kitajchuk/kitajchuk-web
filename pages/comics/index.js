    ...
    <Layout title="comics">
      <main className="comics">
        <div className="comics__books navi">
          ...
          <p>
            <a href="/media/Tabi_No_Hana_Book_01.pdf" target="_blank" download="Tabi_No_Hana_Book_01.pdf">A Flower for Every Time, Book 1</a>
          </p>
          <p>
            <a href="/media/Tabi_No_Hana_Prequel_01.pdf" target="_blank" download="Tabi_No_Hana_Prequel_01.pdf">A Day in Her Life, Prequel 1</a>
          </p>
        </div>
        ...
        <div className="drawings">
          <nav className="drawings__navi" aria-label="Comics Category Navigation">
            {paths.map((obj) => {
              return (
